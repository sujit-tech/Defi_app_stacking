...
import ParticalSettings from "./ParticalSettings.js";
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if (decentralBankData) {
      ...
      let stackingBalance = await decentralBank.methods
        .stakerBalance(this.state.account)
        .call();
      ...
      <div className="App" style={{ position: "relative" }}>
        ...
        <Navbar
          account={
            ...
            "..." +
            this.state.account.slice(37, 42)
          }
        />
        <div className="container-fluid mt-5">
          <div className="row">
            <main
              ...
              style={{ maxWidth: "600 px", minHeight: "100vm" }}
            >
              <div>{content}</div>
            </main>
          </div>
